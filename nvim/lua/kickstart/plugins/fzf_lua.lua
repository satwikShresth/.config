...
function M.config()
  ...
  vim.keymap.set('n', '<leader>fO', '<cmd>ObsidianSearch<cr>', { desc = 'Search Obsidian' })
  vim.keymap.set('n', '<leader>fo', '<cmd>ObsidianWorkspace<cr>', { desc = 'Search Obsidian Workspace' })
